...
const Easy = () => {
  ...
  return (
    <div className="flex py-4 lg:py-0 h-max lg:min-h-screen lg:h-screen flex-col  w-[100vw]  " data-scroll-section ref={pageRef}>
    ...
    <p className=' lg:hidden font-[avenir-light] w-11/12 lg:w-8/12 text-justify'>
